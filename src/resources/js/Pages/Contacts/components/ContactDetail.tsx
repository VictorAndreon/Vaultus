...
export default function ContactDetail({ contact, onEdit, onDelete }: Props) {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            <div className="card" style={{ padding: 28 }}>
                ...
                >
                    ...
                    <div className="flex gap-6">
                        <h2 className="h-2" style={{ lineHeight: 1.15 }}>
                            {contact.name}
                        </h2>
                ...
                >
                    ...
                    <div>
                        ...
                        <div
                            ...
                            style={{ fontSize: 13, marginTop: 4 }}
                        >
                            {contact.last_contacted_relative ?? "—"}
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            style={{ fontSize: 13, marginTop: 4 }}
                        >
                            {contact.remind_after_days
                                ? `${contact.remind_after_days} dias`
                                : "—"}
                        </div>
                    </div>
                </div>
            ...
            {upcoming &&
                upcoming.days_away <= 30 &&
                upcoming.days_away >= 0 && (
                    <div className="card accent-line" style={{ padding: 18 }}>
                        ...
                        >
                            {upcoming.days_away === 0
                                ? "Hoje"
                                : `Em ${upcoming.days_away} dia${upcoming.days_away > 1 ? "s" : ""}`}
                            <span
